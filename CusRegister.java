...
private void validatePass() {
    ...
    if (!password.isEmpty() && password.length() < 6) {
        ...
        Pass.requestFocusInWindow();// Prompt User back to the field
        return;
    }
...
// Add focus listeners for placeholder functionality
    ...
    private void PhoneNumActionPerformed(java.awt.event.ActionEvent evt) {                                         

    }                                        

    private void ICnumActionPerformed(java.awt.event.ActionEvent evt) {                                      
 ...
 // Collect data from GUI components
    ...
    private void ConPassActionPerformed(java.awt.event.ActionEvent evt) {                                        

    }                                       

    private void DriNumActionPerformed(java.awt.event.ActionEvent evt) {                                       
