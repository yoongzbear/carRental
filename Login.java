...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCus.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(btnCus, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void checkForm() {
        ...
        boolean isAnyRoleSelected = btnCus.isSelected() || btnAdmin.isSelected();
    ...
    if (btnCus.isSelected()) {
        filePath = "C:\\javaNetBeans\\CarRental\\src\\carrental\\account.txt"; //path of the file
        role = "Customer";
    } else if (btnAdmin.isSelected()) {
        filePath = "C:\\javaNetBeans\\CarRental\\src\\carrental\\admin.txt";
        role =  "Admin";
    } 
    ...
    if (loginSuccessful) {        
        SessionManager.getInstance().setUser(mail, role, name);        
        //next page
        if (role == "Customer") {
            dispose();
